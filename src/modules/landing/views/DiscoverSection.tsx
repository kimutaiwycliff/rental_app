    ...
    >
      <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <motion.div variants={itemVariants} className="my-12 text-center">
          ...
          <p className="mt-4 text-lg text-primary/95">
            Find your Dream Rental Property Today!
          </p>
          <p className="mt-2 text-primary/90 max-w-3xl mx-auto">
...
const DiscoverCard = ({
  ...
  <div className="px-4 py-12 shadow-lg rounded-lg  md:h-72">
    <div className="bg-primary/75 p-[0.6rem] rounded-full mb-4 h-10 w-10 mx-auto">
      <Image
        src={imageSrc}
        width={30}
        height={30}
    ...
    <h3 className="mt-4 text-xl font-medium text-primary/90">{title}</h3>
    <p className="mt-2 text-base text-primary/85">{description}</p>
  </div>
);
